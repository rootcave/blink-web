...
$(document).ready(function () {
    ...
    $('.menu div.clients-btn').on('click', function () {
        $('.clients-page').fadeIn(1200);
    });
    ...
    $('.close-btn').on('click', function () {
        ...
        $('.profile-page, .portfolio-page, .service-page, .contact-page, .team-page, .clients-page').fadeOut(800);
    });
